...
@endif
<!------------------------------------------نهاية رساله تحديث الفاتوره------------------------------------>


<!------------------------------------------- رساله خطأ التحقق فى الحقول ----------------------------------->
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="Section" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    <!--placeholder-->
                                           <option value="{{$invoices->section->Name}}">{{$invoices->section->Name}}</option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="myFunction()" readonly>
                                    <!--placeholder-->
                                    <option value="{{$invoices->rate_vate}}">{{$invoices->rate_vate}}</option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="Value_VAT" name="Value_VAT"
                                    value="{{$invoices->value_vate}}" readonly>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-control" id="Status" name="Status" required>
                                    ...
                                    <option selected="true"  disabled="disabled" >{{$invoices->status}}</option>
                                       @if($invoices->status_value=="2")
                                         <option value="1">مدفوعة</option>
                                         <option value="3">مدفوعةجزئيا</option>
                                       @elseif($invoices->status_value=="1")
                                         <option value="2">غير مدفوعة </option>
                                         <option value="3">مدفوعةجزئيا</option>
                                      @elseif($invoices->status_value=="3")
                                         <option value="2">غير مدفوعة </option>
                                         <option value="1">مدفوعة</option>

...
@endif
<!--------نهاية رساله الخطأ التحقق من الحقول------------------>
<!-----------------------------------------رسالة تحديث الفاتورة بنجاح----------->
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <form action="{{ route('update_invoice') }}" method="POST">
                    ...
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
                                    <option value="{{ $invoice->rate_vate }}">{{ $invoice->rate_vate }}</option>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="note" rows="3"  >{{ $invoice->notes }}</textarea>
                            </div>
                        </div><br>
  ...
  <script>
    $(document).ready(function() {
        $('select[name="Section"]').on('change', function() {
            ...
            if (SectionId) {
                $.ajax({
                    url: "{{ URL::to('get_product') }}/" + SectionId,
                    type: "GET",
                    dataType: "json",
...
<script>
    function myFunction() {
        ...
        if (typeof Amount_Commission === 'undefined' || !Amount_Commission) {
            ...
            var intResults = Amount_Commission2 * Rate_VAT / 100;         //قيمة ضريبة القيمة المضافة

            var intResults2 = parseFloat(intResults + Amount_Commission2);   //الاجمالى شامل الضريبة

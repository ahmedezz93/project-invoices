					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown nav-item main-header-notification">
								...
								<svg xmlns="http://www.w3.org/2000/svg" class="header-icon-svgs" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bell"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg><span class=" pulse"> {{ Auth::user()->unreadnotifications()->count() }}</span></a>
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											<h6 class="dropdown-title mb-1 tx-15 text-white font-weight-semibold">Notifications {{ Auth::user()->unreadnotifications()->count() }}</h6>
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left">Mark All Read</span>
										</div>
									...
									<div class="main-notification-list Notification-scroll">
										...
										<a class="d-flex p-3 border-bottom" href="{{ route('read_notification',$notification->data['invoice_id']) }}">
											<div class="notifyimg bg-pink">
												<i class="la la-file-alt text-white"></i>
											</div>
											<div class="mr-3">

												<h5 class="notification-label mb-1">{{ $notification->data['invoices_number'] }}</h5>
												<div class="notification-subtext">{{ $notification->data['create_user'] }}</div>
											</div>
											<div class="mr-auto" >

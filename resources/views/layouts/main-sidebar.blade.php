				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ route('paid_invoice') }}">الفواتير المدفوعة </a></li>
							<li><a class="slide-item" href="{{ route('unpaid_invoice') }}">الفواتير الغير مدفوعة</a></li>
							<li><a class="slide-item" href="{{ route('partial_paid__invoice') }}">الفواتير المدفوعة جزئيا</a></li>
							<li><a class="slide-item" href="{{ route('invoice_archive') }}">الفواتير المؤرشفة</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{route('customers_reports') }}">تقارير العملاء</a></li>
						</ul>
					</li>
